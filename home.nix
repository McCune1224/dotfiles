...

{
  ...
  home.packages = [
    ...
    pkgs.vscode-langservers-extracted # HTML/CSS/JSON/ESLint LSP yoinked from VSCode
    pkgs.nodePackages_latest.svelte-language-server # Sveltekit LSP :)
    # pkgs.nodePackages.svelte-language-server 
    pkgs.tailwindcss-language-server # tailwindcss lsp
    pkgs.tailwindcss #Tailwindcss CLI
